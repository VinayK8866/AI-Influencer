...
class AgencyCOO:
    ...
    def run_reel_workflow(self, concept):
        ...
        manager_task = f"Based on this finalized storyboard:\n{storyboard}\n\nGenerate the Asset Requirements list for the creator. Then, draft a highly optimized SEO caption and strategic alt-text for Instagram. Ensure all captions and hashtags are strictly anchored in: {concept}. Start the caption with 'CAPTION: ' so it can be parsed."
